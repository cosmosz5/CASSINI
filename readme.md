...
adapt it to his/her necessities (see also the folder <strong>RCar_GRAVITY</strong>) for an additional example on how to use CASSINI-PCA). The user can run it on the Terminal by typing: 
